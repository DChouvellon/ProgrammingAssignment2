...
#pass the list v to the cacheSolve() function which
#use m's setsolve  function to create a matrix 
#and m's setget function to retrieve the matrix inversed 
...
## Usage:
# Inspired forom From forum "Can we have a demonstration of the mean example?"
